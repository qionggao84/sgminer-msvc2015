...
static cl_int queue_lyra2z330_kernel(struct __clState *clState, struct _dev_blk_ctx *blk, __maybe_unused cl_uint threads)
{
	cl_kernel *kernel;
	unsigned int num;
	cl_int status = 0;
...
#undef A_DARK
  ...
  { "lyra2Z330"   , ALGO_LYRA2Z330   , "", 1, 256, 256, 0, 0, 0xFF, 0xFFFFULL, 0x0000ffffUL, 1, 0,0, lyra2Z330_regenhash   , precalc_hash_blake256, queue_lyra2z330_kernel   , gen_hash, NULL },
